...
| 9 | momentum_v2 | ~~BTC 4h~~ → **ETH 1d** | 0.004→**0.053** / 0.61 | −0.1% · 19 (✓UI, rev 00099) | recalibrated (MF fix): entry_sigma domain was mis-set to the climax region; fixed to moderate-move (σ=0.5). New best ETH 1d OOS 0.053 (12× prior), +8.4% full-window; trailing-1Y flat −0.1% (vs old BTC-4h −3.3%). Still the family's weakest; ETH 4h cell is stronger full-window (+10.7%/Sh 1.12) |
